...
class Oscillations extends StatefulWidget {
  const Oscillations({super.key, required this.appBarTitleText});
  final String appBarTitleText;
  @override
  State<Oscillations> createState() => _OscillationsState();
}

class _OscillationsState extends State<Oscillations> {
