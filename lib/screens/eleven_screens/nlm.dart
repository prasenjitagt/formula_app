    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          SizedBox(height: 20),
          DoubleTapToZoomNetworkWidget(imageHeight: 260, imageName: "nlm0.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 260, imageName: "nlm1.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 130, imageName: "nlm2.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(
              imageHeight: 260, imageName: "nlm14.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 180, imageName: "nlm3.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 220, imageName: "nlm6.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 220, imageName: "nlm7.jpg"),
          SizedBox(height: 10),
          MyDivider(dividerText: "TENSION"),
          DoubleTapToZoomNetworkWidget(imageHeight: 150, imageName: "nlm4.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 250, imageName: "nlm5.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(
              imageHeight: 300, imageName: "nlm10.jpg"),
          SizedBox(height: 10),
          MyDivider(dividerText: "PULLEY"),
          DoubleTapToZoomNetworkWidget(imageHeight: 400, imageName: "nlm8.jpg"),
          SizedBox(height: 10),
          DoubleTapToZoomNetworkWidget(imageHeight: 300, imageName: "nlm9.jpg"),
          SizedBox(height: 10),
